...
let
  sources = {
    ...
    "@kubernetes/client-node-0.12.2" = {
      ...
      version = "0.12.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@kubernetes/client-node/-/client-node-0.12.2.tgz";
        sha512 = "J0UwyFl1Iv/IZ6WMP7LaizBEoKPnqwtc8tIO2q/X+EuDT7eGpPPAMHXSEOC/EI9JGIf0FaJEcDHhB/Dio/mKhw==";
      };
    };
    "@panva/asn1.js-1.0.0" = {
    ...
    "jose-2.0.2" = {
      ...
      version = "2.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/jose/-/jose-2.0.2.tgz";
        sha512 = "yD93lsiMA1go/qxSY/vXWBodmIZJIxeB7QhFi8z1yQ3KUwKENqI9UA8VCHlQ5h3x1zWuWZjoY87ByQzkQbIrQg==";
      };
    };
    "js-tokens-4.0.0" = {
      name = "js-tokens";
    ...
    "openid-client-4.2.0" = {
      ...
      version = "4.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/openid-client/-/openid-client-4.2.0.tgz";
        sha512 = "1S7pLF4xkWkX3l0Gpt69jlXLiO+oRUBjMcc9MZCyoyzz5+KnHUs2D5xMx4RIH/g9QmAwob1zg7mKZLdvOB52Bw==";
      };
    };
    "optionator-0.8.3" = {
      name = "optionator";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@kubernetes/client-node-0.12.2" // {
        dependencies = [
